let Middle = () =>
{
    ...
    <div className='display'>
                <div className='card' data-aos="flip-left">
                    <img src={`${process.env.PUBLIC_URL}/Images/certified.png`} className='card-img-top img' alt='...' style={{ height: '250px',width:'250px',margin:'auto'}} loading="lazy"/>
                ...
                <div className='card' data-aos="flip-left">
                    <img src={`${process.env.PUBLIC_URL}/Images/premium.png`}   className='card-img-top' alt='...' style={{ height: '250px', width: '250px',margin:'auto' }} loading="lazy"/>
                    <div className='card-body'>
                ...
                <div className='card' data-aos="flip-left">
                    <img src={`${process.env.PUBLIC_URL}/Images/expert.png`} className='card-img-top' alt='...' style={{ height: '250px', width: '250px',margin:'auto' }} loading="lazy"/>
                    <div className='card-body'>
                ...
                <div className='card' data-aos="flip-left">
                    <img src={`${process.env.PUBLIC_URL}/Images/rating.png`} className='card-img-top' alt='...' style={{ height: '250px', width: '250px',margin:'auto' }} loading="lazy"/>
                    <div className='card-body'>
